...
/**
 * API for structured output
 *
 * Use this for programmatic output that should be machine-readable.
 */
export interface OutputAPI {
  /**
   * Set structured result
   *
   * This is the "return value" of the plugin, separate from UI output.
   *

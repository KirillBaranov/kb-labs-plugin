/**
 * @module @kb-labs/plugin-runtime-v3/__tests__/permissions
 *
...
import type { PluginContextDescriptor, UIFacade, PlatformServices, PermissionSpec } from '@kb-labs/plugin-contracts-v3';

/**
 * @module @kb-labs/plugin-runtime-v3/__tests__/context-factory
 *
...
describe('createPluginContextV3', () => {
  ...
  it('should wire plugin API correctly', () => {
    ...
    expect(context.api.output).toBeDefined();
    ...
    // Output should have result and meta
    expect(typeof context.api.output.result).toBe('function');
    expect(typeof context.api.output.meta).toBe('function');
  });
